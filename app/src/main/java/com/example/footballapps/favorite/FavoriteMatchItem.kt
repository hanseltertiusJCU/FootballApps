...
data class FavoriteMatchItem(val id : Long, val idEvent : String?, val strEvent : String?, val leagueName : String?, val dateEvent : String?, val leagueMatchWeek : String?, val timeEvent : String?, val homeTeamId : String?, val awayTeamId : String?, val homeTeamName : String?, val awayTeamName : String?, val homeTeamScore : String?, val awayTeamScore : String?){
    companion object {
