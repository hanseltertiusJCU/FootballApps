...
class MatchDetailRepository {
    ...
    fun getMatchDetail(
        ...
        homeTeamId: String,
        awayTeamId: String,
        callback: MatchDetailRepositoryCallback<CombinedMatchTeamsResponse?>
    ) {
        ...
        Observable.zip(
            ...
            override fun onNext(combinedMatchTeamsResponse: CombinedMatchTeamsResponse) {
                val matchDetailResponseEvent =
                    combinedMatchTeamsResponse.matchDetailResponse.events?.first()
