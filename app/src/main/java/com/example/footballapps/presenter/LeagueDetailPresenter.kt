...
class LeagueDetailPresenter(private val leagueDetailView: LeagueDetailView, private val leagueDetailRespository : LeagueDetailRepository) {

    fun getLeagueDetailInfo(leagueId: String) {

        leagueDetailView.dataIsLoading()

        leagueDetailRespository.getLeagueDetail(leagueId, object : LeagueDetailRepositoryCallback<LeagueDetailResponse?> {
